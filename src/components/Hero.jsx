  ...
  return (
    <section id="hero" className="bg-white text-black w-full h-screen flex">
      <div className="container mx-auto flex items-center justify-between sm:p-8 p-0 ">
        {/* Left part */}
        <div className="lg:w-1/2 w-full lg:p-10 sm:p-10">
          ...
          <h1 className="text-5xl 2xl:text-7xl font-extrabold mb-5 text-[#282828]">
        ...
        {/* Right part */}
        <div className="hidden lg:block w-1/2 lg:p-20 sm:p-10">
          <img src={hero} alt="Hero" className="w-full h-auto" />
        </div>
      </div>
      <p className=" absolute bottom-8 flex items-center justify-center w-full text-[#868686]">
        Lorem ipsum dolor sit @ amet consectetu 2023
      </p>
    </section>
  );
};
